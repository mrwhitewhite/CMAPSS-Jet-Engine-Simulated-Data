...
train_1 = train_1.with_columns(pl.col("CYCLE").max().over("UNIT_NUM").alias("RUL"))
train_2 = train_2.with_columns(pl.col("CYCLE").max().over("UNIT_NUM").alias("RUL"))
train_3 = train_3.with_columns(pl.col("CYCLE").max().over("UNIT_NUM").alias("RUL"))
train_4 = train_4.with_columns(pl.col("CYCLE").max().over("UNIT_NUM").alias("RUL"))
